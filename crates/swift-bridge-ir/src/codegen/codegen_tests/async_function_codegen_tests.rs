...
class CbWrapper$some_function {
    ...
    init(cb: @escaping (Result<RustString, Never>) -> ()) {
        self.cb = cb
    }
}
"#,
...
mod extern_rust_async_function_returns_result_opaque {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsAfterTrim(
            r#"
func some_function() async throws -> OkType {
...
class CbWrapper$some_function {
    ...
    init(cb: @escaping (Result<OkType, Error>) -> ()) {
        self.cb = cb
    }
}
"#,
...
mod extern_rust_async_function_returns_result_transparent_enum {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsAfterTrim(
            r#"
func some_function() async throws -> OkEnum {
...
class CbWrapper$some_function {
    ...
    init(cb: @escaping (Result<OkEnum, Error>) -> ()) {
        self.cb = cb
    }
}
"#,
...
mod extern_rust_async_function_returns_result_opaque_rust_transparent_enum {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsAfterTrim(
            r#"
func some_function() async throws -> SomeType {
...
class CbWrapper$some_function {
    ...
    init(cb: @escaping (Result<SomeType, Error>) -> ()) {
        self.cb = cb
    }
}
"#,
...
mod extern_rust_async_function_returns_result_null_transparent_enum {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsAfterTrim(
            r#"
func some_function() async throws -> () {
