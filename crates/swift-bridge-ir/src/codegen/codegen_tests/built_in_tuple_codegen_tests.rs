...
mod extern_rust_tuple_string_primitive {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsManyAfterTrim(vec![
            r#"
func some_function<GenericIntoRustString: IntoRustString>(_ arg1: (GenericIntoRustString, UInt32)) -> (RustString, UInt32) {
...
mod extern_rust_tuple_opaque_rust_primitive {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsManyAfterTrim(vec![
            r#"
func some_function(_ arg1: (SomeType, UInt32)) -> (SomeType, UInt32) {
...
mod extern_rust_tuple_f32_isize_bool {
    ...
    fn expected_swift_code() -> ExpectedSwiftCode {
        ExpectedSwiftCode::ContainsManyAfterTrim(vec![
            r#"
func some_function(_ arg1: (Float, Int, Bool)) -> (Float, Int, Bool) {
